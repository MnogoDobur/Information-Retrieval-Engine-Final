...
public class Stemmer implements TokenChainMember {

	private Stopper theStopper;
	private String s;
        private boolean isStemmingPerformed;

//original code removed
//	private String words[] = { "cats", "dogs", "boys" };
//	private String stem [] = { "cat", "dog", "boy" };
	...
	{
		theStopper = (Stopper) tcm;
	}

	public boolean hasToken( )
	{
		return theStopper.hasToken();
	}

	public String nextToken()
	{	
		s= theStopper.nextToken();
                s=stemIt(s);
		return s;
	}
        public void setStemmingPerformed(boolean isItPerformed){
            isStemmingPerformed = isItPerformed;
        }
/*	
original method
	private void stemIt()
...
//other students version stemIt() method	
 * Stemmer.java
 *
 * Created on 25 February 2002, 23:39
 */
